...
namespace YimMenu
{
	...
	bool Pointers::Init()
	{
		...
		constexpr auto forceRelayConnectionPtrn = Pattern<"48 8B 0D 42 CD 20 03 48 85 C9">("ForceRelayConnection");
		scanner.Add(forceRelayConnectionPtrn, [this](PointerCalculator ptr) {
			ForceRelayConnection = ptr.Add(3).Rip().As<bool*>();
		});
