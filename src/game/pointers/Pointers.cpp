...
namespace YimMenu
{
	...
	bool Pointers::Init()
	{
		...
		constexpr auto writePhysicalScriptGameStateData = Pattern<"48 89 5C 24 08 48 89 6C 24 10 48 89 74 24 18 57 41 56 41 57 48 83 EC 20 4C 8D B1 E0">("WritePhysicalScriptGameStateData");
