...
{
	BoolCommand _ESP("esp", "ESP", "Draws player info and shows their skeleton");
	BoolCommand _ESPName("espname", "Show Name", "Should the ESP show names?");
	BoolCommand _ESPDistance("espdistance", "Show Distance", "Should the ESP show distance?");
	BoolCommand _ESPSkeleton("espskeleton", "Show Skeleton", "Should the ESP show the skeleton?");
}
