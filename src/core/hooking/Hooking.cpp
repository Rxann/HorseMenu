...
namespace YimMenu
{
	Hooking::Hooking()
	{
		...
		BaseHook::Add<Hooks::Spoofing::WritePlayerAppearanceData>(new DetourHook("WritePlayerAppearanceData", Pointers.WritePlayerAppearanceData, Hooks::Spoofing::WritePlayerAppearanceData));
	}
