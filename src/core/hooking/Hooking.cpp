...
namespace YimMenu
{
	Hooking::Hooking()
	{
		...
		BaseHook::Add<Hooks::Spoofing::WritePhysicalScriptGameStateData>(
		    new DetourHook("WritePhysicalScriptGameStateData", Pointers.WritePhysicalScriptGameStateData, Hooks::Spoofing::WritePhysicalScriptGameStateData));
	}
